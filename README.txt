...
python3
	pip install numpy scipy pygame pyopengl pypng sounddevice

= install and run =
git clone --shallow --recursive-submodules --shallow-submodules
cd alkahest
make

tutorial will prompt upon first launch

see docs.tree for an overview